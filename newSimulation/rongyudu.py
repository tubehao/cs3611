...
class Node(object):
    ...
    def __init__(self, node_id, m, redundancy=2):
        ...
        self.predecessors = [self]*redundancy
        self.successors = [self]*redundancy
    ...
    def find_successor(self, key):
        ...
        for succ in self.successors:
            if self.distance(succ.node_id, key) < self.distance(self.successor.node_id, key):
                return succ, 1
